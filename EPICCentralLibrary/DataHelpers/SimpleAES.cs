...
namespace EPICCentralLibrary.DataHelpers
{
    ...
    {
        private readonly byte[] Key = { 12, 217, 45, 11, 56, 26, 85, 45, 114, 213, 27, 162, 37, 112, 54, 209, 241, 34, 54, 176, 173, 53, 129, 29, 24, 26, 17, 218, 131, 223, 87, 128 };
        private readonly byte[] Vector = { 18, 176, 23, 118, 32, 7, 98, 143, 167, 78, 45, 79, 34, 34, 189, 56 };
