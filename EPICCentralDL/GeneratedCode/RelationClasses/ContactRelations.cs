...
namespace EPICCentralDL.RelationClasses
{
	...
	public partial class ContactRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ContactEntity and OrganizationEntity over the m:1 relation they have, using the relation between the fields:
	...
	{
		internal static readonly IEntityRelation OrganizationEntityUsingOrganizationIdStatic = new ContactRelations().OrganizationEntityUsingOrganizationId;
