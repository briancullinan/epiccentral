...
namespace EPICCentralDL.FactoryClasses
{
	...
	{
		private static readonly Dictionary<EPICCentralDL.EntityType, string> _entityTypeNamesCache = new Dictionary<EPICCentralDL.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(EPICCentralDL.EntityType value in Enum.GetValues(typeof(EPICCentralDL.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(EPICCentralDL.EntityType), value));
			}
		}	
