...
namespace EPICCentralDL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UserAssignedLocation'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class UserAssignedLocationEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static UserAssignedLocationEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public UserAssignedLocationEntity() :base("UserAssignedLocationEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="userId">PK value for UserAssignedLocation which data should be fetched into this UserAssignedLocation object</param>
		/// <param name="locationId">PK value for UserAssignedLocation which data should be fetched into this UserAssignedLocation object</param>
		public UserAssignedLocationEntity(System.Int32 userId, System.Int32 locationId):base("UserAssignedLocationEntity")
		{
			InitClassFetch(userId, locationId, null, null);
		}
		...
		public UserAssignedLocationEntity(System.Int32 userId, System.Int32 locationId, IPrefetchPath prefetchPathToUse):base("UserAssignedLocationEntity")
		{
			InitClassFetch(userId, locationId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="userId">PK value for UserAssignedLocation which data should be fetched into this UserAssignedLocation object</param>
		/// <param name="locationId">PK value for UserAssignedLocation which data should be fetched into this UserAssignedLocation object</param>
		/// <param name="validator">The custom validator object for this UserAssignedLocationEntity</param>
		public UserAssignedLocationEntity(System.Int32 userId, System.Int32 locationId, IValidator validator):base("UserAssignedLocationEntity")
		{
			InitClassFetch(userId, locationId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected UserAssignedLocationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((UserAssignedLocationFieldIndex)fieldIndex)
			{
				case UserAssignedLocationFieldIndex.UserId:
					DesetupSyncUser(true, false);
					_alreadyFetchedUser = false;
					break;
				case UserAssignedLocationFieldIndex.LocationId:
		...
		public bool FetchUsingPK(System.Int32 userId, System.Int32 locationId)
		{
			return FetchUsingPK(userId, locationId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 userId, System.Int32 locationId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(userId, locationId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 userId, System.Int32 locationId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(userId, locationId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 userId, System.Int32 locationId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(userId, locationId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.UserId, this.LocationId, null, null, null);
		}
		...
		{
			return new UserAssignedLocationRelations().GetAllRelations();
		}
		...
		/// <param name="userId">PK value for UserAssignedLocation which data should be fetched into this UserAssignedLocation object</param>
		/// <param name="locationId">PK value for UserAssignedLocation which data should be fetched into this UserAssignedLocation object</param>
		/// <param name="validator">The validator object for this UserAssignedLocationEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int32 userId, System.Int32 locationId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(userId, locationId, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", EPICCentralDL.RelationClasses.StaticUserAssignedLocationRelations.LocationEntityUsingLocationIdStatic, true, signalRelatedEntity, "UserAssignedLocations", resetFKFields, new int[] { (int)UserAssignedLocationFieldIndex.LocationId } );		
			_location = null;
		}
		...
		private void SetupSyncLocation(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", EPICCentralDL.RelationClasses.StaticUserAssignedLocationRelations.LocationEntityUsingLocationIdStatic, true, ref _alreadyFetchedLocation, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticUserAssignedLocationRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "UserAssignedLocations", resetFKFields, new int[] { (int)UserAssignedLocationFieldIndex.UserId } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticUserAssignedLocationRelations.UserEntityUsingUserIdStatic, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 userId, System.Int32 locationId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)UserAssignedLocationFieldIndex.UserId].ForcedCurrentValueWrite(userId);
				this.Fields[(int)UserAssignedLocationFieldIndex.LocationId].ForcedCurrentValueWrite(locationId);
		...
		{
			return DAOFactory.CreateUserAssignedLocationDAO();
		}
		...
		{
			return new UserAssignedLocationEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static UserAssignedLocationRelations Relations
		{
			get	{ return new UserAssignedLocationRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.LocationCollection(), (IEntityRelation)GetRelationsForField("Location")[0], (int)EPICCentralDL.EntityType.UserAssignedLocationEntity, (int)EPICCentralDL.EntityType.LocationEntity, 0, null, null, null, "Location", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.UserCollection(), (IEntityRelation)GetRelationsForField("User")[0], (int)EPICCentralDL.EntityType.UserAssignedLocationEntity, (int)EPICCentralDL.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The UserId property of the Entity UserAssignedLocation<br/><br/></summary>
		/// <remarks>Mapped on  table field: "UserAssignedLocation"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 UserId
		{
			get { return (System.Int32)GetValue((int)UserAssignedLocationFieldIndex.UserId, true); }
			set	{ SetValue((int)UserAssignedLocationFieldIndex.UserId, value, true); }
		}

		/// <summary> The LocationId property of the Entity UserAssignedLocation<br/><br/></summary>
		/// <remarks>Mapped on  table field: "UserAssignedLocation"."LocationId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 LocationId
		{
			get { return (System.Int32)GetValue((int)UserAssignedLocationFieldIndex.LocationId, true); }
			set	{ SetValue((int)UserAssignedLocationFieldIndex.LocationId, value, true); }
		}
		...
		public virtual LocationEntity Location
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserAssignedLocations", "Location", _location, true); 
				}
			}
		}
		...
		public virtual UserEntity User
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserAssignedLocations", "User", _user, true); 
				}
			}
		}
		...
		{ 
			get { return (int)EPICCentralDL.EntityType.UserAssignedLocationEntity; }
		}
