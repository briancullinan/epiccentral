...
namespace EPICCentralDL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UserSalt'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class UserSaltEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static UserSaltEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public UserSaltEntity() :base("UserSaltEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="userId">PK value for UserSalt which data should be fetched into this UserSalt object</param>
		public UserSaltEntity(System.Int32 userId):base("UserSaltEntity")
		{
		...
		public UserSaltEntity(System.Int32 userId, IPrefetchPath prefetchPathToUse):base("UserSaltEntity")
		{
		...
		/// <summary>CTor</summary>
		/// <param name="userId">PK value for UserSalt which data should be fetched into this UserSalt object</param>
		/// <param name="validator">The custom validator object for this UserSaltEntity</param>
		public UserSaltEntity(System.Int32 userId, IValidator validator):base("UserSaltEntity")
		{
		...
		protected UserSaltEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((UserSaltFieldIndex)fieldIndex)
			{
				case UserSaltFieldIndex.UserId:
		...
		{
			return new UserSaltRelations().GetAllRelations();
		}
		...
		/// <param name="userId">PK value for UserSalt which data should be fetched into this UserSalt object</param>
		/// <param name="validator">The validator object for this UserSaltEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticUserSaltRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "UserSalt", false, new int[] { (int)UserSaltFieldIndex.UserId } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticUserSaltRelations.UserEntityUsingUserIdStatic, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 userId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)UserSaltFieldIndex.UserId].ForcedCurrentValueWrite(userId);
		...
		{
			return DAOFactory.CreateUserSaltDAO();
		}
		...
		{
			return new UserSaltEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static UserSaltRelations Relations
		{
			get	{ return new UserSaltRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.UserCollection(), (IEntityRelation)GetRelationsForField("User")[0], (int)EPICCentralDL.EntityType.UserSaltEntity, (int)EPICCentralDL.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The UserId property of the Entity UserSalt<br/><br/></summary>
		/// <remarks>Mapped on  table field: "UserSalt"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 UserId
		{
			get { return (System.Int32)GetValue((int)UserSaltFieldIndex.UserId, true); }
			set	{ SetValue((int)UserSaltFieldIndex.UserId, value, true); }
		}

		/// <summary> The Salt property of the Entity UserSalt<br/><br/></summary>
		/// <remarks>Mapped on  table field: "UserSalt"."Salt"<br/>
		...
		{
			get { return (System.String)GetValue((int)UserSaltFieldIndex.Salt, true); }
			set	{ SetValue((int)UserSaltFieldIndex.Salt, value, true); }
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						if(_user!=value)
						{
							((IEntity)value).SetRelatedEntity(this, "UserSalt");
							SetupSyncUser(value);
						}
					}
				}
		...
		{ 
			get { return (int)EPICCentralDL.EntityType.UserSaltEntity; }
		}
