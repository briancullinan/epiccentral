...
namespace EPICCentralDL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public UserRoleEntity(System.Int32 userId, System.Int16 roleId):base("UserRoleEntity")
		{
			InitClassFetch(userId, roleId, null, null);
		}
		...
		public UserRoleEntity(System.Int32 userId, System.Int16 roleId, IPrefetchPath prefetchPathToUse):base("UserRoleEntity")
		{
			InitClassFetch(userId, roleId, null, prefetchPathToUse);
		}
		...
		public UserRoleEntity(System.Int32 userId, System.Int16 roleId, IValidator validator):base("UserRoleEntity")
		{
			InitClassFetch(userId, roleId, validator, null);
		}
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			switch((UserRoleFieldIndex)fieldIndex)
			{
				case UserRoleFieldIndex.UserId:
					...
					break;
				case UserRoleFieldIndex.RoleId:
		...
		public bool FetchUsingPK(System.Int32 userId, System.Int16 roleId)
		{
			return FetchUsingPK(userId, roleId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 userId, System.Int16 roleId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(userId, roleId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 userId, System.Int16 roleId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(userId, roleId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 userId, System.Int16 roleId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(userId, roleId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.UserId, this.RoleId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int32 userId, System.Int16 roleId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(userId, roleId, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", EPICCentralDL.RelationClasses.StaticUserRoleRelations.RoleEntityUsingRoleIdStatic, true, signalRelatedEntity, "UserRoles", resetFKFields, new int[] { (int)UserRoleFieldIndex.RoleId } );		
			_role = null;
		}
		...
		private void SetupSyncRole(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", EPICCentralDL.RelationClasses.StaticUserRoleRelations.RoleEntityUsingRoleIdStatic, true, ref _alreadyFetchedRole, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "Roles", resetFKFields, new int[] { (int)UserRoleFieldIndex.UserId } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 userId, System.Int16 roleId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)UserRoleFieldIndex.UserId].ForcedCurrentValueWrite(userId);
				this.Fields[(int)UserRoleFieldIndex.RoleId].ForcedCurrentValueWrite(roleId);
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.RoleCollection(), (IEntityRelation)GetRelationsForField("Role")[0], (int)EPICCentralDL.EntityType.UserRoleEntity, (int)EPICCentralDL.EntityType.RoleEntity, 0, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.UserCollection(), (IEntityRelation)GetRelationsForField("User")[0], (int)EPICCentralDL.EntityType.UserRoleEntity, (int)EPICCentralDL.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <remarks>Mapped on  table field: "UserRole"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int16 RoleId
		{
			get { return (System.Int16)GetValue((int)UserRoleFieldIndex.RoleId, true); }
			set	{ SetValue((int)UserRoleFieldIndex.RoleId, value, true); }
		}
		...
		public virtual RoleEntity Role
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserRoles", "Role", _role, true); 
				}
			}
		}
		...
		public virtual UserEntity User
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "Roles", "User", _user, true); 
				}
			}
		}
		...
		{ 
			get { return (int)EPICCentralDL.EntityType.UserRoleEntity; }
		}
