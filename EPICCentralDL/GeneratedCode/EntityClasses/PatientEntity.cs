...
namespace EPICCentralDL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary>CTor</summary>
		/// <param name="patientId">PK value for Patient which data should be fetched into this Patient object</param>
		public PatientEntity(System.Int32 patientId):base("PatientEntity")
		{
			InitClassFetch(patientId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="patientId">PK value for Patient which data should be fetched into this Patient object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public PatientEntity(System.Int32 patientId, IPrefetchPath prefetchPathToUse):base("PatientEntity")
		{
			InitClassFetch(patientId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="patientId">PK value for Patient which data should be fetched into this Patient object</param>
		/// <param name="validator">The custom validator object for this PatientEntity</param>
		public PatientEntity(System.Int32 patientId, IValidator validator):base("PatientEntity")
		{
			InitClassFetch(patientId, validator, null);
		}
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case PatientFieldIndex.LocationId:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Location":
					...
					break;
				case "Treatments":
					toReturn.Add(Relations.TreatmentEntityUsingPatientId);
					break;
				default:
					break;				
			}
		...
		public bool FetchUsingPK(System.Int32 patientId)
		{
			return FetchUsingPK(patientId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 patientId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(patientId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 patientId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(patientId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 patientId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(patientId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.PatientId, null, null, null);
		}
		...
		public virtual EPICCentralDL.CollectionClasses.TreatmentCollection GetMultiTreatments(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedTreatments || forceFetch || _alwaysFetchTreatments) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_treatments.GetMultiManyToOne(null, null, null, this, filter);
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int32 patientId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(patientId, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", EPICCentralDL.RelationClasses.StaticPatientRelations.LocationEntityUsingLocationIdStatic, true, signalRelatedEntity, "Patients", resetFKFields, new int[] { (int)PatientFieldIndex.LocationId } );		
			_location = null;
		}
		...
		private void SetupSyncLocation(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", EPICCentralDL.RelationClasses.StaticPatientRelations.LocationEntityUsingLocationIdStatic, true, ref _alreadyFetchedLocation, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 patientId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)PatientFieldIndex.PatientId].ForcedCurrentValueWrite(patientId);
		...
		{
			get { return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.TreatmentCollection(), (IEntityRelation)GetRelationsForField("Treatments")[0], (int)EPICCentralDL.EntityType.PatientEntity, (int)EPICCentralDL.EntityType.TreatmentEntity, 0, null, null, null, "Treatments", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.LocationCollection(), (IEntityRelation)GetRelationsForField("Location")[0], (int)EPICCentralDL.EntityType.PatientEntity, (int)EPICCentralDL.EntityType.LocationEntity, 0, null, null, null, "Location", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The PatientId property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."PatientId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 PatientId
		{
			get { return (System.Int32)GetValue((int)PatientFieldIndex.PatientId, true); }
			set	{ SetValue((int)PatientFieldIndex.PatientId, value, true); }
		}

		/// <summary> The UniqueIdentifier property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."UniqueIdentifier"<br/>
		...
		{
			get { return (System.String)GetValue((int)PatientFieldIndex.UniqueIdentifier, true); }
			set	{ SetValue((int)PatientFieldIndex.UniqueIdentifier, value, true); }
		}
		...
		/// <remarks>Mapped on  table field: "Patient"."LastName"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String LastName
		{
			get { return (System.String)GetValue((int)PatientFieldIndex.LastName, true); }
			set	{ SetValue((int)PatientFieldIndex.LastName, value, true); }
		}

		/// <summary> The MiddleInitial property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."MiddleInitial"<br/>
		...
		{
			get { return (System.String)GetValue((int)PatientFieldIndex.MiddleInitial, true); }
			set	{ SetValue((int)PatientFieldIndex.MiddleInitial, value, true); }
		}

		/// <summary> The PhoneNumber property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."PhoneNumber"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 20<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String PhoneNumber
		{
			get { return (System.String)GetValue((int)PatientFieldIndex.PhoneNumber, true); }
			set	{ SetValue((int)PatientFieldIndex.PhoneNumber, value, true); }
		}

		/// <summary> The EmailAddress property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."EmailAddress"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 128<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String EmailAddress
		{
			get { return (System.String)GetValue((int)PatientFieldIndex.EmailAddress, true); }
			set	{ SetValue((int)PatientFieldIndex.EmailAddress, value, true); }
		}

		/// <summary> The BirthDate property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."BirthDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime BirthDate
		{
			get { return (System.DateTime)GetValue((int)PatientFieldIndex.BirthDate, true); }
			set	{ SetValue((int)PatientFieldIndex.BirthDate, value, true); }
		}

		/// <summary> The Gender property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."Gender"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual EPICCentralDL.Customization.Gender Gender
		{
			get { return (EPICCentralDL.Customization.Gender)GetValue((int)PatientFieldIndex.Gender, true); }
			set	{ SetValue((int)PatientFieldIndex.Gender, value, true); }
		}

		/// <summary> The LocationId property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."LocationId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 LocationId
		{
			get { return (System.Int32)GetValue((int)PatientFieldIndex.LocationId, true); }
			set	{ SetValue((int)PatientFieldIndex.LocationId, value, true); }
		}

		/// <summary> The ReceivedTime property of the Entity Patient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Patient"."ReceivedTime"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime ReceivedTime
		{
			get { return (System.DateTime)GetValue((int)PatientFieldIndex.ReceivedTime, true); }
			set	{ SetValue((int)PatientFieldIndex.ReceivedTime, value, true); }
		}
		...
		public virtual LocationEntity Location
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "Patients", "Location", _location, true); 
				}
			}
		}
		...
		{ 
			get { return (int)EPICCentralDL.EntityType.PatientEntity; }
		}
