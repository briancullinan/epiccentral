...
namespace EPICCentralDL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'PurchaseHistory'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PurchaseHistoryEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PurchaseHistoryEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public PurchaseHistoryEntity() :base("PurchaseHistoryEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="purchaseHistoryId">PK value for PurchaseHistory which data should be fetched into this PurchaseHistory object</param>
		public PurchaseHistoryEntity(System.Int32 purchaseHistoryId):base("PurchaseHistoryEntity")
		{
			InitClassFetch(purchaseHistoryId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="purchaseHistoryId">PK value for PurchaseHistory which data should be fetched into this PurchaseHistory object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public PurchaseHistoryEntity(System.Int32 purchaseHistoryId, IPrefetchPath prefetchPathToUse):base("PurchaseHistoryEntity")
		{
			InitClassFetch(purchaseHistoryId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="purchaseHistoryId">PK value for PurchaseHistory which data should be fetched into this PurchaseHistory object</param>
		/// <param name="validator">The custom validator object for this PurchaseHistoryEntity</param>
		public PurchaseHistoryEntity(System.Int32 purchaseHistoryId, IValidator validator):base("PurchaseHistoryEntity")
		{
			InitClassFetch(purchaseHistoryId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected PurchaseHistoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((PurchaseHistoryFieldIndex)fieldIndex)
			{
				case PurchaseHistoryFieldIndex.LocationId:
					DesetupSyncLocation(true, false);
					_alreadyFetchedLocation = false;
					break;
				case PurchaseHistoryFieldIndex.DeviceId:
					DesetupSyncDevice(true, false);
					_alreadyFetchedDevice = false;
					break;
				case PurchaseHistoryFieldIndex.UserId:
		...
		public bool FetchUsingPK(System.Int32 purchaseHistoryId)
		{
			return FetchUsingPK(purchaseHistoryId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 purchaseHistoryId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(purchaseHistoryId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 purchaseHistoryId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(purchaseHistoryId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 purchaseHistoryId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(purchaseHistoryId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.PurchaseHistoryId, null, null, null);
		}
		...
		{
			return new PurchaseHistoryRelations().GetAllRelations();
		}
		...
		/// <param name="purchaseHistoryId">PK value for PurchaseHistory which data should be fetched into this PurchaseHistory object</param>
		/// <param name="validator">The validator object for this PurchaseHistoryEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int32 purchaseHistoryId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(purchaseHistoryId, prefetchPathToUse, null, null);
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("PurchaseHistoryId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("PurchaseTime", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ScansPurchased", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("AmountPaid", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("TransactionId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("PurchaseNotes", fieldHashtable);
		}
		#endregion
		...
		{
			this.PerformDesetupSyncRelatedEntity( _device, new PropertyChangedEventHandler( OnDevicePropertyChanged ), "Device", EPICCentralDL.RelationClasses.StaticPurchaseHistoryRelations.DeviceEntityUsingDeviceIdStatic, true, signalRelatedEntity, "PurchaseHistories", resetFKFields, new int[] { (int)PurchaseHistoryFieldIndex.DeviceId } );		
			_device = null;
		}
		...
		private void SetupSyncDevice(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _device, new PropertyChangedEventHandler( OnDevicePropertyChanged ), "Device", EPICCentralDL.RelationClasses.StaticPurchaseHistoryRelations.DeviceEntityUsingDeviceIdStatic, true, ref _alreadyFetchedDevice, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", EPICCentralDL.RelationClasses.StaticPurchaseHistoryRelations.LocationEntityUsingLocationIdStatic, true, signalRelatedEntity, "PurchaseHistories", resetFKFields, new int[] { (int)PurchaseHistoryFieldIndex.LocationId } );		
			_location = null;
		}
		...
		private void SetupSyncLocation(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", EPICCentralDL.RelationClasses.StaticPurchaseHistoryRelations.LocationEntityUsingLocationIdStatic, true, ref _alreadyFetchedLocation, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticPurchaseHistoryRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "PurchaseHistories", resetFKFields, new int[] { (int)PurchaseHistoryFieldIndex.UserId } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", EPICCentralDL.RelationClasses.StaticPurchaseHistoryRelations.UserEntityUsingUserIdStatic, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 purchaseHistoryId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)PurchaseHistoryFieldIndex.PurchaseHistoryId].ForcedCurrentValueWrite(purchaseHistoryId);
		...
		{
			return DAOFactory.CreatePurchaseHistoryDAO();
		}
		...
		{
			return new PurchaseHistoryEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static PurchaseHistoryRelations Relations
		{
			get	{ return new PurchaseHistoryRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.DeviceCollection(), (IEntityRelation)GetRelationsForField("Device")[0], (int)EPICCentralDL.EntityType.PurchaseHistoryEntity, (int)EPICCentralDL.EntityType.DeviceEntity, 0, null, null, null, "Device", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.LocationCollection(), (IEntityRelation)GetRelationsForField("Location")[0], (int)EPICCentralDL.EntityType.PurchaseHistoryEntity, (int)EPICCentralDL.EntityType.LocationEntity, 0, null, null, null, "Location", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new EPICCentralDL.CollectionClasses.UserCollection(), (IEntityRelation)GetRelationsForField("User")[0], (int)EPICCentralDL.EntityType.PurchaseHistoryEntity, (int)EPICCentralDL.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The PurchaseHistoryId property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."PurchaseHistoryId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 PurchaseHistoryId
		{
			get { return (System.Int32)GetValue((int)PurchaseHistoryFieldIndex.PurchaseHistoryId, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.PurchaseHistoryId, value, true); }
		}

		/// <summary> The LocationId property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."LocationId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 LocationId
		{
			get { return (System.Int32)GetValue((int)PurchaseHistoryFieldIndex.LocationId, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.LocationId, value, true); }
		}

		/// <summary> The DeviceId property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."DeviceId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 DeviceId
		{
			get { return (System.Int32)GetValue((int)PurchaseHistoryFieldIndex.DeviceId, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.DeviceId, value, true); }
		}

		/// <summary> The UserId property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 UserId
		{
			get { return (System.Int32)GetValue((int)PurchaseHistoryFieldIndex.UserId, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.UserId, value, true); }
		}

		/// <summary> The PurchaseTime property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."PurchaseTime"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime PurchaseTime
		{
			get { return (System.DateTime)GetValue((int)PurchaseHistoryFieldIndex.PurchaseTime, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.PurchaseTime, value, true); }
		}

		/// <summary> The ScansPurchased property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."ScansPurchased"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> ScansPurchased
		{
			get { return (Nullable<System.Int32>)GetValue((int)PurchaseHistoryFieldIndex.ScansPurchased, false); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.ScansPurchased, value, true); }
		}

		/// <summary> The AmountPaid property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."AmountPaid"<br/>
		/// Table field type characteristics (type, precision, scale, length): Money, 19, 4, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Decimal AmountPaid
		{
			get { return (System.Decimal)GetValue((int)PurchaseHistoryFieldIndex.AmountPaid, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.AmountPaid, value, true); }
		}

		/// <summary> The TransactionId property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."TransactionId"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 64<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String TransactionId
		{
			get { return (System.String)GetValue((int)PurchaseHistoryFieldIndex.TransactionId, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.TransactionId, value, true); }
		}

		/// <summary> The PurchaseNotes property of the Entity PurchaseHistory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PurchaseHistory"."PurchaseNotes"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 2048<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String PurchaseNotes
		{
			get { return (System.String)GetValue((int)PurchaseHistoryFieldIndex.PurchaseNotes, true); }
			set	{ SetValue((int)PurchaseHistoryFieldIndex.PurchaseNotes, value, true); }
		}
		...
		public virtual DeviceEntity Device
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "PurchaseHistories", "Device", _device, true); 
				}
			}
		}
		...
		public virtual LocationEntity Location
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "PurchaseHistories", "Location", _location, true); 
				}
			}
		}
		...
		public virtual UserEntity User
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "PurchaseHistories", "User", _user, true); 
				}
			}
		}
		...
		{ 
			get { return (int)EPICCentralDL.EntityType.PurchaseHistoryEntity; }
		}
