...
namespace EPICCentralUnitTest.MockObjects
{
    ...
    {
        public static Action<T, TValue> GetterToSetter<T, TValue>(this Expression<Func<T, TValue>> getter)
        {
        ...
        {
            DynamicMethod m = new DynamicMethod("setter", typeof(void), new Type[] { typeof(T), typeof(TValue) }, typeof(LinqExtensions));
