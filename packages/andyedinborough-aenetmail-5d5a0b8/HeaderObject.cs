...
namespace AE.Net.Mail
{
    public abstract class ObjectWHeaders
    {
        ...
        {
            get { return _Headers ?? (_Headers = HeaderDictionary.Parse(RawHeaders, _DefaultEncoding)); }
        ...
        public string ContentTransferEncoding
        {
            ...
            internal set { Headers.Set("Content-Transfer-Encoding", new HeaderValue(value)); }
        }

        public string ContentType
        {
            get { return Headers["Content-Type"].Value ?? string.Empty; }
            internal set { Headers.Set("Content-Type", new HeaderValue(value)); }
        }
        ...
        {
            get { return _Encoding ?? (_Encoding = Utilities.ParseCharsetToEncoding(Charset, _DefaultEncoding)); }
            set
            {
