...
FixedHeader.prototype = {
    ...
    */
    fnInit: function (oTable, oInit) {
        ...
        if (s.scrollingContainer != document.body) {
            jQuery(s.scrollingContainer).scroll(function () {
                that._fnUpdatePositions.call(that);
            });
        }
    ...
    */
    fnInitSettings: function (s, oInit) {
        if (typeof oInit != 'undefined') {
            ...
            if (typeof oInit.scrollingContainer != 'undefined') {
                s.scrollingContainer = oInit.scrollingContainer;
            }
        }
    ...
    */
    _fnCloneTable: function (sType, sClass, fnClone) {
        ...
        */
        ...
        jQuery(s.scrollingContainer).append(nDiv);
    ...
    */
    _fnMeasure: function () {
        var 
            ...
            cOffset = jQuery(s.scrollingContainer).offset(),
			iParentScrollTop = this._fnSumScroll(s.nTable.parentNode, 'scrollTop'),
			iParentScrollLeft = this._fnSumScroll(s.nTable.parentNode, 'scrollLeft');

        m.iTableWidth = jqTable.outerWidth();
        m.iTableHeight = jqTable.outerHeight();
        m.iTableLeft = (oOffset.left - cOffset.left) + s.nTable.parentNode.scrollLeft;
        m.iTableTop = (oOffset.top - cOffset.top) + iParentScrollTop;
